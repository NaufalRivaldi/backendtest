                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li id="menu-companies" class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="add-companies"><a href="{{ route('company.create') }}"><i class="fa fa-circle-o"></i> Add / Edit</a></li>
                                <li class="list-companies"><a href="{{ route('company.index') }}"><i class="fa fa-circle-o"></i> List</a></li>
                            </ul>
                        </li>
                    </ul>
                </section>
