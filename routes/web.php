...
Route::GROUP(['middleware' => ['auth:user']], function() {
    ...
    Route::get('company/destroy', 'Backend\CompanyController@destroy')->name('company.destroy');
    Route::get('company/postcode', 'Backend\CompanyController@postcode')->name('company.postcode');
});
