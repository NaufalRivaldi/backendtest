$(function () {
    ...
    var formatActionField = function (row, cell, formatterParams) {
        return '<form id="form-delete-' + row.getData()['id'] + '" action="' + rootUrl + '/company/destroy/" method="get">' +
    ...
    // $.ajax({
    //     url: rootUrl+'/api/admin/prefecture/getPrefectureList',
    //     dataType: 'json',
    //     type: 'GET',
    //     success: function(result){
    //         $.each(result, function(index, value){
    //             prefectureObj[value.display_name] = value.display_name;
    //         })
    ...
    $("#datalist").tabulator({
        ...
        columns: [
            ...
            {title: "Name", field: "name", width: 350, headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Email", field: "email", width: 250, headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Postcode", field: "postcode", width: 150, headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Prefecture", field: "data_prefecture", width: 150, headerFilter:"input", headerFilterPlaceholder: " "},
		    {title: "Address", field: "street_address", width: 300, headerFilter:"input", headerFilterPlaceholder: " "},
            {title: "Updated At", field: "updated_at", width: 200, headerFilter: "input", headerFilterPlaceholder: " "},
